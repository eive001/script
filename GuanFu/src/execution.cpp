...
bool execution::handleSeccomp(const pid_t traceesPid) {
  ...
  // rules.
  //myErrorMessage("tracessPid is "+ to_string(tracessPid));
  //myErrorMessage("syscallNumis "+ to_string(syscallNum));
  //printf("traceesPid is     -----   %d ----  syscallnum is --- %ld \n",traceesPid, syscallNum);
